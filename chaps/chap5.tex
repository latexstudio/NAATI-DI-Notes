\chapter{雜類話題II - Miscellaneous Topics II}
...
\begin{itemize}
  ...
  \item \hilight{無症狀的: asymptomatic}
...
\begin{itemize}
  ...
  \item 讓我做...測試: \hilight{order}...test for me
  \item 更容易患上...: be more \hilight{susceptible to} $sth.$
...
\begin{itemize}
  ...
  \item \hilight{amenities}: 便利設施\footnote{比如房屋廣告常常會寫``close to all amenities"} / 生活情趣\footnote{比如因為殘疾會喪失很多活動的權利, 因此lose amenities of life}
...
\begin{itemize}
  ...
  \item 狠狠地推某人: push $sb.$ \hilight{hard} (不是hardly!)
  \item 疼得很厲害: ... \hilight{hurts me very badly}.
...
\begin{itemize}
  ...
  \item \hilight{為某人報復: revenge $sb.$}
  \item \hilight{報復某人: revenge on $sb.$}
\end{itemize}
\end{multicols}
...
\begin{itemize}
  ...
  \item 給人添麻煩: cause trouble \hilight{to} $sb.$ / trouble $sb.$
  \item 分居: live separately and apart
  \item \hilight{付清}貸款: \hilight{pay off} the mortgage
...
\begin{itemize}
  ...
  \item 婚宴: wedding \hilight{banquet}
  \item 人民幣: 翻譯成\hilight{RMB}, 不說Chinese Yuan
  \item 裸婚: marriage without property
  \item 裸考: exam without preparation
  \item \hilight{婚外情: extramarital affair}
...
\begin{itemize}
  ...
  \item \hilight{安頓: settle down in...}
  \item \hilight{深究內幕: dig up the detail}
  \item 兩周的: fortnight
...
\begin{itemize}
  \itemsep0em
  \item \hilight{表補助的詞: benefit, payment, assistance, subsidy, pension, support}
  \item \hilight{表津貼的詞: allowance, bonus}
\end{itemize}
